...
function editTask(columnID, taskID) {
    ...
    bigViewContainer.innerHTML = /*html*/ `
        <div id="big_view_card" class="big-view-card-edit" onclick="stopPropagation(event)">
            <div class="ai-ctr-fe m-btm24">
                <svg onclick="closeBigView(1)" class="big-view-close" width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <mask id="mask0_71720_5473" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="25">
                        <rect y="0.96582" width="24" height="24" fill="#D9D9D9"/>
                    </mask>
                    <g mask="url(#mask0_71720_5473)">
            ...
            <div class="df-column-gap-8 m-btm16">
                ...
                <input class="fs20-fw400 big-view-input-style padding-12-16" type="text" value="${currentTask['title']}">
            </div>
            <div class="df-column-gap-8 m-btm16">
